        ...
        >
          {cell.symbol ? (
            <>
              ...
              />
              {cell.label && (
                <span className="w-full truncate text-center text-sm font-medium text-slate-800 sm:text-base">
                  {cell.label}
                </span>
              )}
            </>
